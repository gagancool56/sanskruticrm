<section class="content-main">
    <form method="post" action="<?= base_url('admin/products/product-create') ?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea placeholder="Type here" name="descr" class="form-control" rows="4"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-4">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    ...
                                    <input placeholder="₹" name="promo_price" type="number" step="0.01" class="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-4 mb-4">
                                <label class="form-label">Tax rate</label>
                                <input type="number" placeholder="%" name="tax_rate" class="form-control" id="product_name" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-12 mb-3">
                                <select class="form-select" name="category_id">
                                    <?php foreach ($product_category as $pcat) : ?>
                                        <option value="<?= $pcat['category_id'] ?>"><?= $pcat['descr'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
